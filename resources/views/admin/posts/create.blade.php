...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Yeni Yazı Ekle</h1>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <div class="mb-5">
                    ...
                    <input type="text" name="title" placeholder="Başlığı buraya yazın..." class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border" required>
                </div>
                
                <div class="mb-5">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Özet (Listing sayfalarında görünür)</label>
                    <textarea name="excerpt" rows="3" placeholder="Yazı hakkında kısa bir özet..." class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border"></textarea>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="mb-5">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_published" value="1" checked class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
